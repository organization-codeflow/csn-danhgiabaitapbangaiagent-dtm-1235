# csn-danhgiabaitapbangaiagent-dtm-1235
...
```bash
git clone https://github.com/organization-codeflow/csn-danhgiabaitapbangaiagent-dtm-1235.git
cd csn-danhgiabaitapbangaiagent-dtm-1235
```
...
- Truy cập: https://sonarcloud.io/project/overview?id=csn-danhgiabaitapbangaiagent-dtm-1235
- Xem các metrics:
